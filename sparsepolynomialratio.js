...
sparsepolynomialratio.prototype.parse = function (strornode) {  //  2017.9
    ...
    console.log(strornode)
    console.log('</strornode>')
    if (strornode instanceof String || typeof (strornode) == 'string') if (strornode.indexOf('base') != -1) { var a = JSON.parse(strornode); return new sparsepolynomialratio(a.base, new sparseplacevalueratio1().parse(JSON.stringify(a.pv))) }    //  2017.10
    ...
    if (node.type == 'SymbolNode') {
        ...
        if (node.fn == 'unaryMinus') {
            var c = new sparsepolynomialratio(1, sparseplacevalueratio1.parse(0)).sub(a);
        } else if (node.fn == 'unaryPlus') {
            var c = new sparsepolynomialratio(1, sparseplacevalueratio1.parse(0)).add(a);
        } else {
        ...
        return new sparsepolynomialratio(1, new sparseplacevalueratio1().parse(node.value));
    }
}
...
sparsepolynomialratio.prototype.align = function (other) {    // Consolidate alignment    2015.9
    ...
    if (this.base != other.base) { alert('Different bases : ' + this.base + ' & ' + other.base); return new sparsepolynomialratio(1, sparseplacevalueratio1.parse('%')) }
}
