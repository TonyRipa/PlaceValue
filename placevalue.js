...
placevalue.prototype.parse = function (man) {    // 2017.9
	...
	//	return new placevalue(new wholeplacevalue(this.whole.datatype).parse((typeof man == 'string') ? man.replace(/\.(?![^\(]*\))/g, '') : man), exp + getexp(man));	//	2018.6	Removed
...
placevalue.prototype.getreal = function (i) { return this.whole.getreal(i - this.exp) }		//	2018.6	laplace
