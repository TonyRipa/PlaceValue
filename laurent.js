...
class laurent extends abstractpolynomial {	//	+2023.4
	...
	parse(strornode) {    //  2017.9
		...
		if (node.type == 'ConstantNode') {
			...
			return c;
		} else if (node.type == 'ParenthesisNode') {	//	+2023.4
	...
	// tohtml() { // Replacement for toStringInternal 2015.7	//	-2023.4
	...
	/*	-2023.4
	add(other) { this.align(other); return new laurent(this.base, this.pv.add(other.pv)); }
	sub(other) { this.align(other); return new laurent(this.base, this.pv.sub(other.pv)); }
	times(other) { this.align(other); return new laurent(this.base, this.pv.times(other.pv)); }
	divide(other) { this.align(other); return new laurent(this.base, this.pv.divide(other.pv)); }
	divideleft(other) { this.align(other); return new laurent(this.base, this.pv.divideleft(other.pv)); }
	dividemiddle(other) { this.align(other); return new laurent(this.base, this.pv.dividemiddle(other.pv)); }
	remainder(other) { this.align(other); return new laurent(this.base, this.pv.remainder(other.pv)); }
	pointadd(other) { this.align(other); return new laurent(this.base, this.pv.pointadd(other.pv)); }
	pointsub(other) { this.align(other); return new laurent(this.base, this.pv.pointsub(other.pv)); }
	pointtimes(other) { this.align(other); return new laurent(this.base, this.pv.pointtimes(other.pv)); }
	pointdivide(other) { this.align(other); return new laurent(this.base, this.pv.pointdivide(other.pv)); }
	pointpow(other) { this.align(other); return new laurent(this.base, this.pv.pointpow(other.pv)); }
	*/
