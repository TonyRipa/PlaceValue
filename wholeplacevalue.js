...
wholeplacevalue.prototype.equal = function (other) { return this.parse(this.equals(other) ? 1 : 0); }	//	+2020.10
...
wholeplacevalue.prototype.pointequals = function (other) { this.check(other); return this.f((x, y)=>x.equal(y),other);}								//	+2020.10
