...
sparseplacevaluerational1.parse = function (arg) {
    ...
    if (typeof arg == "number") return new sparseplacevaluerational1([[rational.parse(arg), rational.parse(0)]]);    //  2d array    2016.10
...
sparseplacevaluerational1.prototype.get = function (i) { //  2017.6
...
sparseplacevaluerational1.prototype.tohtml = function () {  // Replaces toStringInternal 2015.7
    var me = this.clone();                          // Reverse will mutate  2015.9
    return JSON.stringify(me.points.reverse());
}

sparseplacevaluerational1.prototype.toString = function (sTag) {                                 //  sTag    2015.11
    var ret = "";
...
sparseplacevaluerational1.prototype.digit = function (i, sTag, long) {                           //  sTag    2015.11
    if (sTag) return this.digitpair(i, '<s>', '</s>', true, long);
    return this.digitpair(i, '', String.fromCharCode(822), false, long);
}

sparseplacevaluerational1.prototype.digitpair = function (i, NEGBEG, NEGEND, fraction, long) {  // 2015.12
...
sparseplacevaluerational1.prototype.pointadd = function (other) { return this.f0(rational.prototype.add, other); }       //  2017.6
sparseplacevaluerational1.prototype.pointsub = function (other) { return this.f0(rational.prototype.sub, other); }       //  2017.6
sparseplacevaluerational1.prototype.pointtimes = function (other) { return this.f(rational.prototype.times, other); }    //  2017.6
sparseplacevaluerational1.prototype.pointdivide = function (other) { return this.f(rational.prototype.divide, other); }  //  2017.6
sparseplacevaluerational1.prototype.pointpow = function (other) { return this.f0(rational.prototype.pow, other); }       //  2017.6
sparseplacevaluerational1.prototype.clone = function () { return new sparseplacevaluerational1(this.points.slice()) }
sparseplacevaluerational1.prototype.negate = function () { return sparseplacevaluerational1.parse(0).sub(this); } //  2017.6
sparseplacevaluerational1.prototype.round = function () { return new sparseplacevaluerational1(this.points.filter(function (x) { return !x[1].isneg(); })) }  //  2017.6

sparseplacevaluerational1.prototype.f = function (f, other) {  //  2017.6
    var ret = this.clone();
...
sparseplacevaluerational1.prototype.f0 = function (f, other) {  //  2017.6
    var ret = this.clone();
    for (var i = 0; i < ret.points.length; i++)
...
sparseplacevaluerational1.prototype.times = function (top) {
    var points = []
...
sparseplacevaluerational1.prototype.scale = function (scalar) {
...
sparseplacevaluerational1.prototype.unscale = function (scalar) {  //  2016.5
    if (!(scalar instanceof rational)) scalar = rational.parse(scalar);
    var ret = this.clone();
...
sparseplacevaluerational1.prototype.remainder = function (den) {  //  2016.5
    return this.sub(this.divide(den).round().times(den));   //  2017.6  round
}

sparseplacevaluerational1.prototype.divideleft = function (den) {   //  2017.1
    var num = this;
    var iter = math.max(num.points.length, den.points.length);
    var quotient = divideh(num, den, iter);
    return quotient;
...
sparseplacevaluerational1.prototype.dividemiddle = sparseplacevaluerational1.prototype.divide
...
sparseplacevaluerational1.prototype.gcd = function () {   // 2016.5
    var list = [];
    for (var i = 0; i < this.points.length; i++)
